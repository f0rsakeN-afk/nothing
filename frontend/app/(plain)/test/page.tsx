    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      <div className="flex flex-col items-center gap-6 text-center max-w-sm w-full">
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold tracking-tight">Component Testing</h1>
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <Button 
            ...
            variant="default" 
            className="gap-2 rounded-xl h-12 shadow-lg shadow-primary/20 bg-primary hover:bg-primary/90"
          >
        ...
        <OnboardingModal isOpen={onboardingOpen} onOpenChange={setOnboardingOpen} />
      </div>
    </div>
  );
}
