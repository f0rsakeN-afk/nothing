    ...
    <div className="flex flex-col gap-8 lg:py-2">
      ...
      <div>
        ...
        <p className="mt-3 text-base text-muted-foreground leading-relaxed max-w-sm">
          Whether you have a question, a bug to report, or a product idea —
      ...
      <div className="grid grid-cols-2 gap-3">
        <a
          ...
          className="group flex flex-col gap-2.5 rounded-xl border border-border p-4 transition-colors duration-200 hover:bg-muted/50"
        >
